...
public class OpenCartDesafio2 {
	...
	public static String[][] testOpenCartProducts_FileCSV() throws Exception {
		...
		BufferedReader br = new BufferedReader(new FileReader("TestOpenCartProducts_NombrePrecio.csv"));
		@SuppressWarnings("resource")
		BufferedReader br2 = new BufferedReader(new FileReader("TestOpenCartProducts_NombrePrecio.csv"));
